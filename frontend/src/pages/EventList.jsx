  ...
  return (
    <Card variant="default" className="flex flex-col gap-[10px] p-5">
      <div className="flex items-center justify-between">
        <span className="inline-block self-start rounded-full bg-[var(--accent-soft)] px-[10px] py-[3px] text-[11px] font-bold text-[var(--accent-ink)]">
      ...
      <span className="text-[17px] font-normal text-[var(--text-h)]">{event.name}</span>
      ...
      <Link
        ...
        className="mt-[6px] rounded-lg bg-[var(--accent-soft)] p-2 text-center text-[13px] font-semibold text-[var(--accent-ink)] no-underline hover:bg-[var(--accent-softer)]"
      >
        Manage project →
      </Link>
    </Card>
