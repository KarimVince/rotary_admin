...
export default function EventCategoryEntryPage({
  ...
  totalFieldLabel,
  showTotalRow = false,
  // 2026-08-08: Sponsors passes false to hide the format select + Generate
  // Report button "for now" — Costs keeps it (default true). Removing them
  // also moves the Category filter to the left, since it's no longer
  // pushed right by the report controls.
  showReport = true,
  listCategoriesFn,
  listEntriesFn,
  createEntryFn,
